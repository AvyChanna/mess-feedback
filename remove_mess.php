...
if(mysqli_num_rows($result) > 0)
{
    ...
    <td class="text-center px-0" ><button type="button" name="delete_btn" data-id4="'.$row["id"].'" class="btn btn-primary btn_delete button-xs px-3 py-1 mx-1">DELETE</button></td>
    </tr>
    ';
    }
