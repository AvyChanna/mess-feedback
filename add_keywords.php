		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark"> <a class="navbar-brand"
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item active"> <a class="nav-link" href="#">Add Keywords<span
		...
		<div class="col-12 col-sm-8 col-md-6 col-xl-4 offset-0 offset-xl-4 offset-md-3 offset-sm-2 pb-5"> 
			...
			<div class="form-group">
				...
				<div class="input-group mb-3">
						<input type="text" class="form-control" id="keyword" placeholder="Enter new keyword" name="keyword" required>
				</div>
			</div>
			<div class="form-group">
				<label for="rating">Rating:</label>
				<div class="input-group mb-3">
					<input type="text" class="form-control" id="rating" placeholder="Enter rating for new keyword" name="rating" required>
				</div>
			</div>
