...
<div class="container-fluid main page">
	<div class="text-light pt-5 pb-5 pb-md-0">
		...
		<div class="col-12 col-sm-8 col-md-6 col-xl-4 offset-0 offset-xl-4 offset-md-3 offset-sm-2 pb-5"> 
			...
			<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="input-group mb-3">
						...
						<div id="password-toggle2" class="input-group-append"><span class="fas input-group-text fa-eye-slash"></span></div>
					</div>
				</div>
			...
			<br>
			<!-- TODO register here-->
			<div class="container-fluid text-center"> <a href="/login.php" class="mb-5">Already have an account? Login Here</a> </div>
		</div>
	</div>
</div>
<div class="footer">
